...
{	
	...
	(*derivs)(x+ a2*h,ytemp,ak2, ke_x, scale_factor, nvar_x);
	for (i=1;i<=n;i++)
		{ytemp[i]=y[i]+h*(b31*dydx[i]+b32*ak2[i]);}
	
	(*derivs)(x+a3*h,ytemp,ak3, ke_x, scale_factor, nvar_x);
	for (i=1;i<=n;i++)
		{ytemp[i]=y[i]+h*(b41*dydx[i]+b42*ak2[i]+b43*ak3[i]);}
		
	(*derivs)(x+a4*h,ytemp,ak4, ke_x, scale_factor, nvar_x);
	for (i=1;i<=n;i++)
		{ytemp[i]=y[i]+h*(b51*dydx[i]+b52*ak2[i]+b53*ak3[i]+b54*ak4[i]);}
	
	(*derivs)(x+a5*h,ytemp,ak5, ke_x, scale_factor, nvar_x);
	for (i=1;i<=n;i++)
		{ytemp[i]=y[i]+h*(b61*dydx[i]+b62*ak2[i]+b63*ak3[i]+b64*ak4[i]+b65*ak5[i]);}
	
	(*derivs)(x+a6*h,ytemp,ak6, ke_x, scale_factor, nvar_x);
	for (i=1;i<=n;i++)
	...
	free_vector(ak6,1,(long)n);
	free_vector(ak5,1,(long)n);
	free_vector(ak4,1,(long)n);
	free_vector(ak3,1,(long)n);
	free_vector(ak2,1,(long)n);
